...
## 2026-07-01：用户要"捋范围"，我甩了一整张分类全景表（标准/主观/下游/边界 + 术语），又把人淹了
...
## 2026-07-01：给推荐时把决策 tie-breaker 默认成"更快能用/MVP 先跑通"，用户要的是"完善好"
...
## 2026-07-01：修 F-1 时往 shell-单引号包裹的 awk 程序注释里塞了 `'  '` 单引号，提前闭合、整个 awk 失灵
